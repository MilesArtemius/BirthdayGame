...
public class AssetConstants {
    ...
    public static final int SPECIAL_HITS = 10;
    ...
    public static final int CARDBOARD_HITS = 10;
    ...
    public static final int SMTH_ELSE_HITS = 10;
    ...
    public static final int SMTH_ELSE_CONTENT_count = 1;
